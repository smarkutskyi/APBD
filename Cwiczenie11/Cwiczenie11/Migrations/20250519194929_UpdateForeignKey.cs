        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Emali = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Doctor",
                columns: new[] { "IdDoctor", "Emali", "FirstName", "LastName" },
                values: new object[] { 1, "<EMAIL>", "Jan", "Kowalski" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Opium", "Opium", "Antybiotyczne" },
                    { 4, "Apap", "APAP", "Antybiotyczne" }
                });
